...
if exist "SendMessage.lzma" del "SendMessage.lzma"
if exist "SendMessage.tar"  del "SendMessage.tar"
if exist "SendMessage.tgz"  del "SendMessage.tgz"
...
title "%COVDIR%\bin\cov-build.exe" --dir "cov-int" nant -buildfile:..\default.build SendMessage
"%COVDIR%\bin\cov-build.exe" --dir "cov-int" nant -buildfile:..\default.build SendMessage
...
title Creating "SendMessage.lzma"...
tar caf "SendMessage.lzma" "cov-int"
goto End
...
if exist "%SEVENZIP%" (
  title Creating "SendMessage.tar"...
  "%SEVENZIP%" a -ttar "SendMessage.tar" "cov-int"
  "%SEVENZIP%" a -tgzip "SendMessage.tgz" "SendMessage.tar"
  if exist "SendMessage.tar" del "SendMessage.tar"
  goto End
)
